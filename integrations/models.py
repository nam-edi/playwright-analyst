...
class GitLabConfiguration(models.Model):
    ...
    artifact_path = models.CharField(
        max_length=500, verbose_name="Chemin vers le JSON", help_text="Chemin du fichier JSON dans les artifacts"
    )
...
class GitHubConfiguration(models.Model):
    ...
    workflow_name = models.CharField(
        max_length=200, verbose_name="Nom du workflow", help_text="Nom du workflow GitHub Actions"
    )
    artifact_name = models.CharField(
        max_length=200, verbose_name="Nom de l'artifact", help_text="Nom de l'artifact contenant les résultats"
    )
    json_filename = models.CharField(
        max_length=200, verbose_name="Nom du fichier JSON", help_text="Nom du fichier JSON dans l'artifact"
    )
