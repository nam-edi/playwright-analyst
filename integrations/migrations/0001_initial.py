    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access_token', models.CharField(help_text="GitHub Personal Access Token. ⚠️ Sera stocké de manière sécurisée et masqué dans l'interface.", max_length=200, verbose_name="Token d'accès")),
                ...
                ('ci_config', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='github_config', to='integrations.ciconfiguration')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access_token', models.CharField(help_text="Token avec permissions API. ⚠️ Sera stocké de manière sécurisée et masqué dans l'interface.", max_length=200, verbose_name="Token d'accès")),
                ...
                ('ci_config', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='gitlab_config', to='integrations.ciconfiguration')),
            ],
            options={
