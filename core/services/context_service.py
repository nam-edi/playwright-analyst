...
class ContextService:
    ...
    def get_users_with_restricted_access():
        ...
        """
        return User.objects.filter(usercontext__isnull=False, usercontext__projects__isnull=False).distinct()
    ...
    def get_users_without_context():
        ...
        manager_viewer_users = User.objects.filter(groups__name__in=["Manager", "Viewer"]).distinct()
