...
class TagModelTest(TestCase):
    ...
    def test_tag_creation(self):
        ...
        tag = Tag.objects.create(name="Critical", color="#ff0000", project=self.project)
    ...
    def test_tag_str_method(self):
        ...
        tag = Tag.objects.create(name="Critical", project=self.project)
    ...
    def test_tag_unique_name_per_project(self):
        ...
        Tag.objects.create(name="Critical", project=self.project)
    ...
    def test_tag_unique_color_per_project(self):
        ...
        Tag.objects.create(name="Critical", color="#ff0000", project=self.project)

        # Créer un tag avec la même couleur dans le même projet devrait lever une erreur
        with self.assertRaises(Exception):
            Tag.objects.create(name="Important", color="#ff0000", project=self.project)
    ...
    def test_tag_different_projects_same_name_color(self):
        ...
        tag1 = Tag.objects.create(name="Critical", color="#ff0000", project=self.project)

        # Même nom et couleur mais projet différent - devrait fonctionner
        tag2 = Tag.objects.create(name="Critical", color="#ff0000", project=project2)
...
class TestModelTest(TestCase):
    ...
    def test_test_creation(self):
        ...
        test = Test.objects.create(
            title="Login Test", file_path="tests/login.spec.js", line=10, column=5, project=self.project
        )
    ...
    def test_test_unique_constraint(self):
        ...
        Test.objects.create(title="Login Test", file_path="tests/login.spec.js", line=10, column=5, project=self.project)
...
class TestExecutionModelTest(TestCase):
    ...
    def test_execution_str_method(self):
        ...
        execution = TestExecution.objects.create(
            project=self.project, start_time=start_time, duration=5000.0, raw_json={"test": "data"}
        )
    ...
    def test_execution_ordering(self):
        ...
        execution1 = TestExecution.objects.create(
            project=self.project, start_time=start_time1, duration=5000.0, raw_json={"test": "data1"}
        )
        execution2 = TestExecution.objects.create(
            project=self.project, start_time=start_time2, duration=6000.0, raw_json={"test": "data2"}
        )
...
class TestResultModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.execution = TestExecution.objects.create(
            project=self.project, start_time=datetime.now(), duration=5000.0, raw_json={"test": "data"}
        )
