...
class ProjectFeatureModelTest(TestCase):
    ...
    def test_project_feature_creation(self):
        ...
        feature = ProjectFeature.objects.create(
            feature_key='evolution_tracking',
            is_enabled=True,
    ...
    def test_project_feature_ordering(self):
        ...
        feature_tags = ProjectFeature.objects.create(
            feature_key='tags_mapping',
            project=self.project
        )
        feature_evolution = ProjectFeature.objects.create(
            feature_key='evolution_tracking',
            project=self.project
        )
    ...
    def test_project_feature_different_projects(self):
        ...
        feature1 = ProjectFeature.objects.create(
            feature_key='evolution_tracking',
            project=self.project
        )
        
        # Devrait fonctionner sur un autre projet
        feature2 = ProjectFeature.objects.create(
            feature_key='evolution_tracking',
            project=project2
        )
...
class ProjectViewsTest(TestCase):
    ...
    def test_project_list_access(self):
        """Test l'accès à la liste des projets (via select_project)"""
